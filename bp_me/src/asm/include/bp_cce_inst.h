...
typedef enum {
  ...
  ,e_gad_op                              = 0x1   // Generate Auxiliary Data
...
typedef enum {
  ...
  ,e_alu_lsh                             = 0x2   // Left Shift
  ,e_alu_rsh                             = 0x3   // Right Shift
  ,e_alu_and                             = 0x4   // Bit-wise AND
  ,e_alu_or                              = 0x5   // Bit-wise OR
  ,e_alu_xor                             = 0x6   // Bit-wise XOR
  ,e_alu_neg                             = 0x7   // Bit-wise negation (unary)
  ,e_alu_not                             = 0x8   // Logical Not (unary)
  ,e_alu_nand                            = 0x9   // Logical Not of Bit-wise And
  ,e_alu_nor                             = 0xA   // Logical Not of Bit-wise Or
...
typedef enum {
  ...
  ,e_branch_lt                           = 0x2   // Branch if A < B
  ,e_branch_le                           = 0x3   // Branch if A <= B
...
typedef enum {
  ...
  ,e_spec_rd_spec                        = 0x8 // Read spec bit to GPR
...
#define bp_cce_inst_dwtype_pad (bp_cce_inst_type_u_width-bp_cce_inst_mux_sel_addr_width \
  ...
  -bp_cce_inst_mux_sel_coh_state_width-bp_coh_bits)
...
#define bp_cce_inst_s_width (bp_cce_inst_width+2)
